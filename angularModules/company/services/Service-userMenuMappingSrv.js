angular.module('touterbee').service('userMenuMappingSrv',['$http','$alert','bbConfig', function userMenuMappingSrv($http,$alert,bbConfig) {
    ...
    {
      var inputData={'roleId':$scope.roleId,'companyId':$scope.companyId,'range':range,'prefix':prefix};
    ...
    var inputData={'fkUserRoleMappingId':fkUserRoleMappingId,'companyId':companyId,'roleId':fkRoleId};
    $http({
...
this.FnSaveUserMenu=function ($scope){ //function to save the user menus.
   ...
   this.FnLoadUsers=function ($scope,companyId,range,search_key){    
    var inputData={'companyId': companyId,'prefix': search_key,'range':range};
