          ...
          function ( $stateProvider,   $urlRouterProvider ) {
            $stateProvider
              ...
              .state('home.main.userRegistration.step2', {
               ...
               .state('home.main.domainVerification', {
                url: '/domainVerification',
                views:{
                  'innercontent':{
                    templateUrl: 'angularModules/company/partials/Partial-domain-verification.html',
                     controller: 'DomainVerificationCtrl'
                  }
                }
              })
                .state('home.main.addNewDomain', {
                url: '/addNewDomain',
                views:{
                  'innercontent':{
                    templateUrl: 'angularModules/company/partials/Partial-add-new-domain.html',
                     controller: 'AddNewDomainCtrl'
                  }
                }
              })
              .state('home.main.addSocialConfig', {
                      ...
                      views:{
                  'innercontent':{
                      controller: 'SocialconfighomeCtrl',
